...
const activateAccount_model_1 = require("../../Models/activateAccount.model");
const activateAccountQuery = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield activateAccount_model_1.ActivateAccount.create(data);
});
...
const verifyActivateTokenQuery = (token) => __awaiter(void 0, void 0, void 0, function* () {
    return yield activateAccount_model_1.ActivateAccount.findOne({ token });
});
...
const deleteActivateTokenQuery = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield activateAccount_model_1.ActivateAccount.deleteMany({ id });
});
